@extends('layout.master', [
    'page_title' => 'Tạo mới sản phẩm | Seafashion Admin Page',
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group label-floating is-empty{{$errors->has('categoryId')?' has-error':''}}">
                                        ...
                                        <input type="text" name="categoryId" class="form-control{{$errors->has('categoryId')?' error':''}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group label-floating is-empty{{$errors->has('collectionId')?' has-error':''}}">
                                        <label class="control-label"></label>
                                        <input type="text" name="collectionId" class="form-control{{$errors->has('collectionId')?' error':''}}">
                                        <span class="material-input"></span></div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group label-floating is-empty{{$errors->has('detail')?' has-error':''}}">
                                        <label class="control-label"></label>
                                        <input type="text" name="detail" class="form-control{{$errors->has('detail')?' error':''}}">
                                        <span class="material-input"></span></div>
                                </div>
                            </div>
                            <div class="row">
