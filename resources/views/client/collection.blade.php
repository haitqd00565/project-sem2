@extends('layout.client-layout-v2',['page_title'=>'Bộ sưu tập'])
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 p-b-50">
                    ...
                    <!-- Product -->
                    <div class="row">
                        @foreach($list_colleciton as $collection)
                            <div class="col-sm-12 col-md-6 col-lg-3 p-b-50">
                                ...
                                <div class="block2">
                                    ...
                                    <div class="block2-overlay trans-0-4">
                                        ...
                                        <div class="block2-btn-addcart w-size1 trans-0-4" id="add-cart-{{$collection->id}}">
                                            <!-- Button -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5">{{$list_colleciton -> links()}}</div>
                </div>
            </div>
        </div>
    </section>
