        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Nhập tên người dùng hoặc email">
                        <input class="input100" type="text" name="username" placeholder="Tên người dùng hoặc email">
